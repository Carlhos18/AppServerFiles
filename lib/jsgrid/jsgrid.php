...
//search:true,align:"right",forceFit : true,autowidth: true,
    ...
    private function crearGrilla(){
        ...
        if($this->multiselect!='false')$cadena.="multikey: 'ctrlKey',\n";
...
PDFE;
        ...
        $cadena .= "jQuery('#$this->tabla').jqGrid('navGrid','#$this->pager',{edit:false,pdf:false,excel:false,add:false,del:false,search:false,columns:false});";
    ...
    public function addColumnas($nombre,$nombreView,$width=150,$sortable=false,$search='true',$align='left'){
