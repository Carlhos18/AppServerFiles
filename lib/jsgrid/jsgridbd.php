...
//        $text = strtoupper($params['searchString']);
    ...
    public function to_json(){
        ...
        $this->sql = ' select '.$this->sqlSelect.' from '.$this->sqlfrom.$where.$order.'  limit '.$this->numRowsPagina.'  offset ?';
        $this->sqlTotal = ' select '.$this->sqlSelect.' from '.$this->sqlfrom.$where.$order;
