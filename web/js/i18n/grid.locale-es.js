...
//            odata:["igual ","no igual a","menor que","menor o igual que","mayor que","mayor o igual a","empiece por","no empiece por","termina por","no termina por","contiene","no contiene"],
            odata:["contiene","igual "],
            groupOps:[{
                op:"AND",
                text:"todo"
            },{
