/*
 ...
 Date: 2013-10-06
*/
(function(a){a.jgrid=a.jgrid||{};a.extend(a.jgrid,{version:"4.5.4",htmlDecode:function(a){return a&&("&nbsp;"===a||"&#160;"===a||1===a.length&&160===a.charCodeAt(0))?"":a?String(a).replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&quot;/g,'"').replace(/&amp;/g,"&"):a},htmlEncode:function(a){return a?String(a).replace(/&/g,"&amp;").replace(/\"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):a},format:function(d){var e=a.makeArray(arguments).slice(1);null==d&&(d="");return d.replace(/\{(\d+)\}/g,
...
a(w).attr(l.attr);a(n).append(s);a.jgrid.bindEv.call(e,w,l);a("td:eq(1)",s).append(w);!0===d.autosearch&&a(w).change(function(){b();return!1})}}break;case "text":v=void 0!==l.defaultValue?l.defaultValue:"";a("td:eq(1)",s).append("<input type='text' style='width:100%;padding:0px;' name='"+(k.index||k.name)+"' class='input-focus'  id='gs_"+k.name+"' value='"+v+"'/>");a(n).append(s);l.attr&&a("input",n).attr(l.attr);a.jgrid.bindEv.call(e,a("input",n)[0],l);!0===d.autosearch&&(d.searchOnEnter?a("input",n).keypress(function(a){return 13===
